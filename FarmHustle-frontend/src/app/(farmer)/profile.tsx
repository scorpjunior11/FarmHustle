...
import { getProducts, updateProfilePhoto } from "../../api/client";
...
export default function FarmerProfileScreen() {
  ...
  useEffect(() => {
    ...
    getProducts()
      .then((products) => {
        if (!cancelled) {
          setStatCount(products.filter((p) => p.farmer.id === user.id).length);
        }
      })
      .catch(() => {
      ...
      <View style={styles.body}>
        ...
        >
          <View style={styles.historyLeft}>
            ...
            <Text style={styles.historyText}>Sales history</Text>
          </View>
