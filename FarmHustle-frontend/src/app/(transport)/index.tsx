...
export default function DeliveryJobsScreen() {
  // Mock data — Sprint 1 only (no backend connection yet)
  const jobs = [
    {
      id: 1,
      from: 'Kumasi, Ashanti',
    ...
    },
    {
      ...
      to: 'Tamale, Northern',
      item: 'Tomatoes',
      icon: 'food-apple', // placeholder icon
      iconType: 'MaterialCommunityIcons',
      quantity: '200kg',
      fee: 'GHS 120',
      posted: '2 hours ago',
    ...
    <SafeAreaView style={styles.safeArea} edges={['top']}>
      ...
      <View style={styles.headerRow}>
        ...
        <Text style={styles.brandTitle}>
          FarmHustle <Text style={styles.leafIcon}>🌱</Text>
        </Text>
        <TouchableOpacity>
              ...
              <View style={styles.metricColumn}>
                ...
                <View style={styles.metricValueRow}>
                  {job.iconType === 'MaterialCommunityIcons' ? (
                    <MaterialCommunityIcons name={job.icon as any} size={18} color="#4CAF50" style={styles.metricIcon} />
                  ) : (
                    <Ionicons name={job.icon as any} size={18} color="#4CAF50" style={styles.metricIcon} />
                  )}
